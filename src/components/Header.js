  ...
  return (
    <header className="w-full fixed top-0 z-10 p-2 md:p-5">
      <nav className="container mx-auto">
          ...
          <div className="flex items-center justify-between px-4 py-2 md:px-6 md:py-4">
            <div className="hidden md:flex w-full items-center">
              <div className="w-1/4 flex justify-start">
                <Link href="/" className="font-semibold text-2xl text-indigo-600 hover:text-indigo-700 transition-colors pl-[40px]">
                  YDP Shop
                </Link>
              </div>
              ...
              <div className="w-2/4 flex items-center justify-center gap-4">
                <div className="relative">
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white border border-slate-300 hover:border-slate-400 text-slate-700 font-medium text-sm transition-colors duration-200"
                  >
                    ...
                    <div className="absolute top-full left-0 mt-2 w-56 bg-white rounded-lg shadow-lg border border-slate-200 py-2 z-50">
                      {categories.map(category => (
                        <button
                          ...
                          className={`w-full text-left px-4 py-2.5 transition-colors duration-200 font-medium text-sm
                ...
                <form onSubmit={handleSearch} className="flex-grow max-w-md">
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-2 pl-10 pr-4 rounded-lg border border-slate-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 outline-none transition-colors font-medium text-sm bg-white"
                    />
                    <svg
              ...
              <div className="w-1/4 flex items-center justify-end pr-6 space-x-2">
                <Link href="/profile" className="p-2 rounded-lg text-slate-700 hover:bg-slate-100 transition-colors duration-200">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                  </svg>
                </Link>
                <Link href="/wishlist" className="relative p-2 rounded-lg text-slate-700 hover:bg-slate-100 transition-colors duration-200">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                <Link href="/cart" className="relative p-2 rounded-lg text-slate-700 hover:bg-slate-100 transition-colors duration-200">
                  <svg
            ...
            <div className="flex md:hidden items-center justify-between w-full">
              ...
              <Link href="/" className="font-semibold text-xl text-indigo-600 hover:text-indigo-700 transition-colors">
                YDP Shop
              </Link>
        ...
        {open && (
          <div className="absolute left-0 right-0 top-full mt-2 bg-white rounded-lg shadow-lg border border-slate-200 md:hidden mx-2">
            <div className="p-3 flex flex-col gap-2">
              <div className="border-b border-slate-200 pb-2 mb-2">
                ...
                {categories.map(category => (
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 transition-colors duration-200 mb-1 font-medium text-sm
                      ${activeCategory === category.id 
                        ? 'bg-slate-100 text-slate-900' 
                        : 'text-slate-700 hover:bg-slate-50'}`}
                  >
              ...
              <Link
                ...
                className="text-slate-700 hover:bg-slate-50 px-3 py-2 rounded-lg transition-colors duration-200 flex items-center gap-3 font-medium text-sm"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                </svg>
              ...
              >
                ...
                <span>Cart</span>
                {totalItems > 0 && (
                  <span className="ml-auto flex h-5 w-5 items-center justify-center rounded-full bg-indigo-500 text-xs font-medium text-white">
                    {totalItems}
                  </span>
                )}
              </Link>
